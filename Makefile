...
doc-clean: ## Clean auxiliary files generated by LaTeX.
	rm -f $(DOC_DIR)/*.aux $(DOC_DIR)/*.log $(DOC_DIR)/*.out $(DOC_DIR)/*.toc $(DOC_DIR)/*.docx $(DOC_DIR)/*.fdb_latexmk $(DOC_DIR)/*.fls $(DOC_DIR)/*.bbl $(DOC_DIR)/*.bcf $(DOC_DIR)/*.blg $(DOC_DIR)/*.lof $(DOC_DIR)/*.lot $(DOC_DIR)/*.run.xml $(DOC_DIR)/*.xdv
