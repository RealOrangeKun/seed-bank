...
\figslot{10-deployment.pdf}{Deployment view: the React frontend, the FastAPI backend, the PostgreSQL database, and the ClickHouse analytics warehouse.}{fig:deployment}
