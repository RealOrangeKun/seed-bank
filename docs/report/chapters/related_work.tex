...
trained, with which data, and how each version scored. Seed Bank keeps this
record itself: each evaluation run stores its metrics in PostgreSQL alongside a
Markdown report in object storage, so trained models can be recorded and compared
without standing up a separate experiment-tracking service.
